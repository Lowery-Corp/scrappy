...
from api.v1.endpoints import auth, health, blob, file_chunks, file_jobs, user_files
...
api_router.include_router(user_files.router, prefix="/user-files", tags=["user_files"])
